...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Joel" => "joel@okcupid.com" }
  # Or just: spec.author    = "Joel"
  # spec.authors            = { "Joel" => "joel@okcupid.com" }
  # spec.social_media_url   = "https://twitter.com/Joel"
  ...
  spec.source       = { :git => "https://github.com/joelconnects/KnobControlTestPod.git", :tag => "1.0.0" }
